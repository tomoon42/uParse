...
> 基于[ https://github.com/dcloudio/uParse](https://github.com/dcloudio/uParse)优化的uniapp组件，主要优化内容
>
> 1. 优化行内元素的展示问题
> 2. 优化原组件树最大层数11层的问题
>
...
>
> 为了兼容uiapp实现组件递归调用，需在全局注册vnode组件
...
```js
import vnode from "@/components/u-parse/components/vnode.vue"
